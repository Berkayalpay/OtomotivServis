...
namespace OtomotivServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public async Task<ActionResult> CreateAsync() //Arac Id si istiyor bizden araç eklemek ıcın bu nedenle bir tane daha service gerekli.
        {
        ...
        {
            ViewBag.AracId = new SelectList(await _serviceArac.GetAllAsync(), "Id", "Modeli"); //Edit metodunda araç Id gelmesi için.
