...
namespace OtomotivServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public async Task<ActionResult> IndexAsync() //Buraya Servis listesi göndermemiz gerekiyor bunu bekliyor.
        {
        ...
        {
            var model = await _service.FindAsync(id); //GetAllAsync değil find async kullanılmalı 
            return View(model);
        }
